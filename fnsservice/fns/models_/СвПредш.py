...
class СвПредш(models.Model): #4.60
    ...
    ГРНДата = models.ForeignKey(ГРНДатаТип, null=True, blank=True, related_name='СвПредш_Дата',
...
class СвПредшCreate:
    ...
    def __init__(self, item):
        if item is not None:
            ...
            self.a = СвПредш.objects.create(ОГРН=self.ОГРН, ИНН=self.ИНН, НаимЮЛПолн=self.НаимЮЛПолн,
